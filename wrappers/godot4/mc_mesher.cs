...
public class McmMeshBuffer : IDisposable
{
	...
	protected void ApplyMesh(ref ArrayMesh mesh, Vector3u boundsMaxU)
	{
		if (mesh == null)
			return;
		...
		McmCopyVertices(m_meshBuffer, vertices);
		McmCopyNormals(m_meshBuffer, normals);
		McmCopyIndices(m_meshBuffer, indices);
	...
	protected static extern void McmCopyVertices(IntPtr meshBuffer, [Out] Vector3[] dstBuffer);
	...
	protected static extern void McmCopyNormals(IntPtr meshBuffer, [Out] Vector3[] dstBuffer);
	...
	protected static extern void McmCopyIndices(IntPtr meshBuffer, [Out] Int32[] dstBuffer);
}
